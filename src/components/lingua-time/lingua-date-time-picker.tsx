...
function generateSuggestions(
  ...
  if (!inputValue.length) {
    return defaultSuggestions.map((suggestion) => ({
      /*TODO LOOK FOR A PROPER FALLBACK*/
      date: generateDate(suggestion) || new Date(),
...
export const LinguaDateTimePicker = forwardRef<
  HTMLInputElement,
  DateTimePickerProps
...
LinguaDateTimePicker.displayName = "LinguaDateTimePicker";
